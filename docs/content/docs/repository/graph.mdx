...
graph TD
    ...
    A -->|children| F["fishing.plugin.morino.party/.../index.json<br/>plugins: MoripaFishing, MoripaFishing-*"]
...
[
    ...
    {
        "index": "https://fishing.plugin.morino.party/mpm/paper/index.json"
    }
]
```
