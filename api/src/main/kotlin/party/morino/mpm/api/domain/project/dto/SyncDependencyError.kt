...
sealed class SyncDependencyError {
    ...
    data class CircularDependency(
         ...
         * エラーメッセージを生成する
         */
        override fun toMessage(): String = "循環依存が検出されました: ${cycle.joinToString(" → ")}"
    }
    ...
    data class TargetNotFound(
         ...
         * エラーメッセージを生成する
         */
        override fun toMessage(): String = "プラグイン '$pluginName' が同期対象とする '$targetPlugin' が見つかりません"
    }
    ...
    data class TargetIsUnmanaged(
         ...
         * エラーメッセージを生成する
         */
        override fun toMessage(): String = "プラグイン '$pluginName' の同期対象 '$targetPlugin' は手動管理（unmanaged）です"
    }
}