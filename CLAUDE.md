...
現在行っている作業が終了したら、branchを切ってcommit push pr作成を行ってください。
...
- クラスごとにファイルを分けてください。 データクラスに関しても同様で、1クラス1ファイルにしてください。
- 適切にpackageを作成してください。
...
- paper/src/main/kotlin/party/morino/mpm/ にプラグインのメインクラスを配置します。
